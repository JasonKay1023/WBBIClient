...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"返回", @"")
                                                                             style:(UIBarButtonItemStyleDone)
                                                                            target:self
                                                                            action:@selector(BackBPressed:)];
...
- (void)BackBPressed:(id)button
{
    [_flip_container_delegate showFront];
}
