...
@implementation AlipayPayAction

- (void)paymentWithTradeID:(NSString *)trade_id inPrice:(float)price forGoods:(NSString *)title withDetail:(NSString *)description
{
    /*
    ...
    order.seller = seller;
    order.tradeNO = trade_id; //订单ID（由商家自行制定）
